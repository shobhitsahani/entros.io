...
const FINDINGS = [
  ...
  },
  {
    ...
    body: "Neural vocoders can produce acoustic perturbation values higher than human baselines, not just lower. This overturns the assumption that synthetic speech is \"too perfect.\" Effective detection must account for artifacts in both directions. Entros's validation pipeline is calibrated against these findings.",
  },
  {
    title: "Touch-IMU Shockwave Is a Binary Liveness Signal",
    source: "Device physics, validated by BioMoTouch 2025",
    body: "Physical touch interaction produces measurable hardware responses that programmatic touch injection does not. Scripted emulators, headless browsers, and automation frameworks generate valid touch coordinates without triggering the corresponding physical sensor responses. Entros uses this discrepancy as a liveness signal on supported devices.",
  },
];
  ...
  return (
    <section className="mx-auto max-w-5xl px-6 py-20">
      ...
      <p className="mt-3 max-w-2xl text-foreground/70">
        Single-modality detection is losing to modern AI. Entros&apos;s multi-modal
      ...
      <div className="mt-16">
        <div className="rounded-xl border border-cyan/10 bg-cyan/5 px-6 py-5">
          <p className="font-mono text-sm font-semibold text-foreground">
            The core advantage of Entros
          </p>
          <p className="mt-2 text-sm text-foreground/70 leading-relaxed">
            Entros captures voice, movement, and touch simultaneously and
            ...
            harder problem. Entros&apos;s Trust Score then requires maintaining that
